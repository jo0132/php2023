        ...
        <div class="contents">
            <div class="contents__nav">
                ...
                <ul class="filter option-set" data-filter-group="color">
                        <li><a id="filters" href="community.php#community__dot" data-filter="*" class="selected">ALL</a></li>
                        <li class="webstandard"><a href="communityHot.php#community__dot" data-filter=".HOT" >HOT🔥</a></li>
                        <li class="webstandard"><a href="communityMyPlant.php?commuCategory='내식물자랑'#community__dot" data-filter=".myPlant">내 식물자랑</a></li>
...
<?php
    ...
    $sql = "SELECT * FROM plantyCommu WHERE commuDelete = 0 ORDER BY commuID DESC LIMIT {$viewLimit},{$viewNum}";
    $result = $connect -> query($sql);
                            ...
                            <div class="cont_wrap">
                                ...
                                <div class="cont_desc">
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <span class="user"><?=$plantyCommu['commuAuthor']?></span>
