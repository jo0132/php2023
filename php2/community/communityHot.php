            ...
            <div class="contents__nav">
                <div id="options" class="gridly">
                    <ul class="filter option-set" data-filter-group="color">
                        ...
                        <li class="webstandard"><a href="communityHot.php#community__dot" data-filter=".HOT" class="selected">HOT🔥</a></li>
...
<?php
    ...
    $sql = "SELECT * FROM plantyCommu WHERE commuDelete = 0 ORDER BY commuView DESC LIMIT {$viewLimit},{$viewNum}";
    $result = $connect -> query($sql);
